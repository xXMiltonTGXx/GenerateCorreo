      ...
      <div class="flex h-16 items-center justify-between">
        <div class="flex items-center">
          <div class="flex-shrink-0">
            <a href="/generatecorreo/dashboard"><img class="h-8 w-8" src="https://tailwindui.com/img/logos/mark.svg?color=indigo&shade=500" alt="Your Company"></a>
          </div>
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
              <a href="/generatecorreo/mostrarP" class="rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white" aria-current="page">Mostrar Listado Persona</a>  
              <a href="/generatecorreo/buscarP" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Buscar Persona</a> 
            </div>
          </div>
        </div>
        <div class="hidden md:block">
    ...
    <div class="md:hidden" id="mobile-menu">
      ...
      <div class="border-t border-gray-700 pb-3 pt-4">
        ...
        <div class="mt-3 space-y-1 px-2">
          ...
          <a href="/generatecorreo/logout" class="block rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-gray-700 hover:text-white">Cerrar Sesión</a>
        </div>
      </div>
    </div>
  </nav>
